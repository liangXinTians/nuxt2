<template>
  <div class="home">
    ...
    <div class="top">
      ...
      <img
        loading="lazy"
        src="../../../assets/images/xinyangzhijia/zhenyue/1.jpg"
        alt=""
        @load="handleImgLoad"
      />
      <div class="banner">
    ...
    <div class="singLand">
      <div class="content">
        ...
        <div class="contents">
          <div class="contentss">
            信养之家臻悦护理院是由上海市卫健委批准设立的一家集医疗、康复、护理、临终关怀于一体的专科型护理院，是上海市医保定点单位。总建筑面积8790.12㎡，分为地上10层，地下1层。地下一层设有员工餐厅、设备用房及物资暂存间。地上一层为接待区，拥有挂号接待区、诊疗科室、检验科室、放射科室、中心药房、康复大厅等，还有护理院餐厅，地上二层主要为行政办公区域，三层至十层为长者居住区。
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="image">
        <div class="img_left">
          <div class="img1">
            <img
              loading="lazy"
              src="../../../assets/images/xinyangzhijia/zhenyue/2.jpg"
              alt=""
            />
            <div class="img_font">一楼-康复医学科-康复大厅</div>
          </div>
          <div class="img2">
            <img
              loading="lazy"
              src="../../../assets/images/xinyangzhijia/zhenyue/3.jpg"
              alt=""
            />
            <div class="img_font">住院-楼层-护理四人间</div>
          </div>
        </div>
        <div class="img_right">
          <img
            ...
            alt=""
          />
          <div class="img_font">一楼-接待大厅</div>
        </div>
      </div>
    ...
    <div class="bottoms">
      ...
      <div v-if="changeReview === 0" class="bottom1" id="bottom1">
        <div class="bottom_tops">
          <div class="contents">
            <div class="content">
              <div class="content_content">
                信养之家臻悦护理院目前共开放床位293张。舒适户型以双人间、三人间、四人间为主，室内面积约为25-30㎡，居住精致、设备齐全，房内卫生间、洗浴、衣柜、呼叫、中心供氧等医疗、生活设施一应俱全。另设有公共娱乐设施、休息区、阅览区、助浴间等，为不同需求的长者们提供针对性的设备设施。
              </div>
              <div class="content_content">
                护理院在中国护理行业中概念领先，率先采用专科化病区分类模式，做到按病种分科收治，进行精细化临床医疗管理和特色化优质护理服务，为长者提供医疗护理、生活照料、心理和营养治疗；同时也为生命垂危者提供临终关怀服务。护理院内设置康复医学科、认知症专科、脑卒中专科、肿瘤专科和综合专科。
              </div>
            </div>
          </div>
          <!-- <div class="go_video">
            <div>点击视频，走进臻悦护理院</div>
          ...
          <!-- <div class="video" id="zhenyuefuVideo"
            @click="toggleVideo()">
            <video src="/信养之家宝山大场养老院.m4v" loop id="myVideos1"
              :poster="require('../../../assets/images/xinyangzhijia/dachang/5.jpg')" type="video/mp4">
          ...
          <div class="box">
            <div class="left text-box">
              ...
              <div class="content-box">
                ...
                <div class="content">
                  各科配备专科医生和分病种临床经验丰富的医疗护理团队、生活护理团队，真正做到病情诊断更明确，治疗方案更有效、康复效果更有保障，生活护理服务更有针对性和专业化。护理院精湛的医护专业团队长期为：脑卒中、脑梗后遗症、脑中风的长者；长期卧床、生活不能自理的长者；各类手术后需康复、护理的长者；内科慢性病及残障长者；癌症晚期长者等，提供24h全身心照护服务。
                </div>
              </div>
            </div>
            <div class="right">
      ...
      <div v-if="changeReview === 2" class="bottom3">
        ...
        >
          ...
          <div class="img_list" id="imgList">
            <div class="imgs" v-for="(item, index) in bottom3s" :key="index">
              <div class="img">
                <img
                  loading="lazy"
...
export default {
  ...
  head: {
    ...
    meta: [
      { charset: "utf-8" },
      {
        hid: "keywords",
        name: "keywords",
        content: "臻悦护理院，臻悦养老院，信养之家护理院，养老院，护理院",
      },
      {
        hid: "description",
        name: "description",
  ...
  data() {
    return {
      ...
      threeBigImg: [
        ...
        require("~/assets/images/xinyangzhijia/zhenyue/2.jpg"),
        require("~/assets/images/xinyangzhijia/zhenyue/3.jpg"),
      ],
      bottom1Img: require("~/assets/images/xinyangzhijia/zhenyue/5.jpg"),
      showImg: true,
      // 服务亮点要放大的图片
      serviceHighlightsBigImg: [
        require("~/assets/images/xinyangzhijia/zhenyue/6.jpg"),
        require("~/assets/images/xinyangzhijia/zhenyue/7.jpg"),
      ],
      // 云参观 所有的内容
      bottom3: [],
      //遍历单独的内容
  ...
  methods: {
    ...
    toggleVideo() {
      ...
      const checkImg = document.getElementById("zhenyuefuVideo");
    ...
    // 视频叉号
    handleImageClickss() {
      const checkImg = document.getElementById("zhenyueVideo");
      const cross = document.getElementById("crossss1");
  ...
  .bottoms {
    ...
    .bottom1 {
      .bottom_tops {
        ...
        background-color: rgb(195, 185, 204);
      ...
      .bottom_titles {
        ...
        .bottom_title {
          ...
          .active {
            ...
            background-color: rgb(66, 89, 130);
            color: #fff;
          }
        }
      }
