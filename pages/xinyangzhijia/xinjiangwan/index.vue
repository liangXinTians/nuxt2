<template>
  <div class="home">
    ...
    <div class="top">
      ...
      <img
        loading="lazy"
        src="../../../assets/images/xinyangzhijia/xinjiangwan/1.jpg"
        alt=""
        @load="handleImgLoad"
      />
      <div class="banner">
        <div class="banners">
          ...
          <div class="subTitle">杨浦新江湾养老院</div>
          <div class="borders"></div>
          <div class="content">机构连锁 85+高龄失能失智长辈</div>
        </div>
      </div>
    ...
    <div class="singLand">
      <div class="content">
        ...
        <div class="contents">
          <div class="contentss">
            杨浦新江湾养老院位于杨浦江湾核心板块。占据地理资源优势，毗邻杨浦区中心医院，医疗资源便捷优享，轨道8号线市光路站可达，区域内多条公交线路途径，可快速抵达人民广场及多个中心区域。
          </div>
          <div class="contentss">
            机构总建筑面积约5700平方米，并配备约500平米户外庭院，整体装修风格融汇了上海摩登与莫兰迪风格，给人感觉既新潮又复古，经典回忆与现代气息交相辉映，有趣的空间设计丝丝点点渗透着法式浪漫的风尚感，完全颠覆了传统养老院的想象，整体环境更具蓬勃清新的生命力。
          </div>
          <div class="contentss">
            杨浦新江湾养老院开放有163张高品质床位，其中含认知症单元7床，主力户型有单人间、双人间、三人间等。机构于2022年下半年对外营业，截止目前入住率已超过70%。
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="image">
        <div class="img_left">
          <div class="img1">
            <img
              loading="lazy"
              src="../../../assets/images/xinyangzhijia/xinjiangwan/2.jpg"
              alt=""
            />
            <div class="img_font">双人间</div>
          </div>
          <div class="img2">
            <img
              loading="lazy"
              src="../../../assets/images/xinyangzhijia/xinjiangwan/3.jpg"
              alt=""
            />
            <div class="img_font">餐桌</div>
          </div>
        </div>
        <div class="img_right">
          <img
            loading="lazy"
            src="../../../assets/images/xinyangzhijia/xinjiangwan/小组团.jpg"
            alt=""
          />
          <div class="img_font">小组团区域</div>
        </div>
      </div>
    ...
    <div class="bottoms">
      ...
      <div v-if="changeReview === 0" class="bottom1" id="bottom1">
        <div class="bottom_tops">
          <div class="contents">
            <div class="content">
              <div class="content_content">
                机构传承信养之家小组团、精细化、融入家庭社交感的规划，以8—10间居室（10-15位长者）作为一个单元，组织空间内的功能规划及人流导向，将小型社交感的客厅、餐厅与厨房融入，形成除休息时段以外，长者就餐、社交、活动的流动空间，并顺势成为运营服务组织的枢纽。这样的方式也是信养之家在传统养老行业内的率先尝试。
              </div>
              <div class="content_content">
                在机构的空间设计中，“去养老机构化”是给人的第一印象，无论是外在感受，还是室内布局，自然而然让人忽略掉这是家养老机构。去机构化的理念渗透到整个环境氛围中，更将居家生活体验表现到每一个设计细节中。比如卫生间的铺装色系镶嵌、比如房间收纳体系的悉心考量。在这里，环境赋予了长者们满满的松弛感，可以发自内心的感受到安心与惬意，找到家的温暖。
              </div>
              <!-- logo部分 -->
              <!-- <div class="logo">
                <img loading="lazy"
                  src="../../../assets/images/xinyangzhijia/bg_l_mazie-yellow.png"
                  alt=""
                />
              </div> -->
            </div>
          ...
          <div class="go_video">
            <div>点击视频，走进杨浦新江湾养老院</div>
            <div class="go_icon">→</div>
          </div>
          <div class="video" id="xinjiangwanVideo" @click="toggleVideo()">
            <video
              :src="$config.videoUrl + '/信养之家杨浦新江湾养老院.mp4'"
        ...
        <div class="bottom_tops_mobiles">
          ...
          <div class="video" id="xinjiangwanVideo" @click="toggleVideoMobile()">
            <video
              :src="$config.videoUrl + '/信养之家杨浦新江湾养老院.mp4'"
              :controls="showControls"
              controlslist="nodownload"
              id="myVideos1_mobile"
              :poster="
                require('../../../assets/images/xinyangzhijia/xinjiangwan/video_poster.png')
              "
            >
              Your browser does not support the video tag.
            </video>
            <div
              class="play_button"
              id="playButtons1_mobile"
              @click="toggleVideoMobile()"
            >
              <a-icon type="play-circle" />
            </div>
          </div>
          ...
          <div class="box">
            <div class="left text-box">
              ...
              <div class="content-box">
                <div class="sub-title">六个专业岗位协同照护</div>
                <div class="content">
                  配置了有针对性的康养服务科目，实现了显著的服务升级。除了生活照料和专业护理，专技康养岗位每天为长者提供包括四肢、吞咽、语言在内的能力训练，尽可能保持长者身体技能。在这里，每一位长者的日常，都由六个专技岗位协同提供服务。
                </div>
              </div>
            </div>
            <div class="right">
        ...
        <div class="bottom_down">
          <div class="box">
            ...
            <div class="right text-box">
              ...
              <div class="content-box">
                <div class="sub-title">国际认知症照护单元</div>
                <div class="content">
                  两个认知症单元，以国际照护标准配置服务人员，为中重度认知症长者指定专属照护与康复计划。独创小组团服务理念，缩小服务单位，仅以6-10间居室（约10-15位老人）提供小组团服务。面向生活不能自理、患有认知症、有老年疾病或者其他康复需求的高龄长者，还有“老年康复”和“记忆之家”两大特色服务。
                </div>
              </div>
            </div>
          </div>
      ...
      <div v-if="changeReview === 2" class="bottom3">
        <div class="bottom_titles">
          <div class="bottom_title">
            ...
            <div
              class="button_img"
              @click="changeImgReviews(3)"
              :class="{ active: changeImgReview === 3 }"
            >
              服务设施
            </div>
          </div>
  ...
  head: {
    ...
    meta: [
      { charset: "utf-8" },
      {
        ...
        name: "keywords",
        content:
          "杨浦区养老院，新江湾养老院，世界路养老院，信养之家养老院，养老院",
      },
      {
        hid: "description",
        name: "description",
        content:
          "杨浦新江湾养老院位于杨浦江湾核心板块。占据地理资源优势，毗邻杨浦区中心医院，医疗资源便捷优享，轨道8号线市光路站可达，区域内多条公交线路途径，可快速抵达人民广场及多个中心区域。总建筑面积约5700平方米，并配备约500平米户外庭院，开放有163张高品质床位，其中含认知症单元7床，主力户型有单人间、双人间、三人间等。机构于2022年下半年对外营业，截止目前入住率已超过70%。",
      },
    ],
  },
  data() {
    return {
      ...
      mobile: false,
      changeReview: 0,
      changeImgReview: 0, // 默认显示项目生活
      // 三个图片
      threeBigImg: [
        require("~/assets/images/xinyangzhijia/xinjiangwan/小组团.jpg"),
        require("~/assets/images/xinyangzhijia/xinjiangwan/2.jpg"),
        require("~/assets/images/xinyangzhijia/xinjiangwan/3.jpg"),
      ],
      showImg: true,
      //控件属性
      showControls: false,
      ...
      serviceHighlightsBigImg: [
        require("~/assets/images/xinyangzhijia/xinjiangwan/康复理疗区.jpg"),
        require("~/assets/images/xinyangzhijia/xinjiangwan/认知症区阳台.jpg"),
      ],
      // 云参观 所有的内容
      bottom3: [],
      //遍历单独的内容
  ...
  methods: {
    ...
    toggleVideo() {
      ...
      if (this.showControls) {
        ...
        const checkImg = document.getElementById("xinjiangwanVideo");
    ...
    toggleVideoMobile() {
      const video = document.getElementById("myVideos1_mobile");
      const playButton = document.getElementById("playButtons1_mobile");
      if (this.showControls) {
        return;
      } else {
        this.showImg = false;
  ...
  .bottoms {
    ...
    .bottom1 {
      .bottom_tops {
        ...
        height: 29.5vw;
        min-height: 500px;
        background-color: rgb(233, 216, 197);
      ...
      .bottom_titles {
        ...
        .bottom_title {
          ...
          .active {
            ...
            background-color: rgb(179, 117, 60);
            color: #fff;
          }
        }
      }
